        ...
        <div class="invoice-details">
            ...
            <div class="client-info">
                ...
                @if($invoice->case)
                    ...
                    @if($invoice->case->court_name)
                        <div class="info-item">
                            <span class="label">المحكمة:</span>
                            {{ $invoice->case->court_name }}
                        </div>
                    @endif
                @endif
            </div>
        ...
        <div class="total-section">
            <table class="total-table">
                <tr>
                    ...
                    <td class="total-amount">{{ number_format($invoice->amount, 2) }}</td>
                </tr>
                ...
                @if($invoice->discount_amount > 0)
                    <tr>
                        ...
                        <td class="total-amount">-{{ number_format($invoice->discount_amount, 2) }}</td>
                    </tr>
                @endif
                
                <tr class="grand-total">
                    <td class="total-label">المجموع الكلي:</td>
                    <td class="total-amount">{{ currency($invoice->total_amount) }}</td>
                </tr>
                
                @if($invoice->paid_amount > 0)
                    <tr>
                        <td class="total-label">المبلغ المدفوع:</td>
                        <td class="total-amount">{{ number_format($invoice->paid_amount, 2) }}</td>
                    </tr>
                    ...
                    @if($invoice->total_amount - $invoice->paid_amount > 0)
                        <tr style="color: #dc3545; font-weight: bold;">
                            ...
                            <td class="total-amount">{{ number_format($invoice->total_amount - $invoice->paid_amount, 2) }}</td>
                        </tr>
                    @endif
                @endif
            </table>
