...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'نظام تبيان - إدارة مكتب المحاماة'); ?></title>
            ...
            <nav class="col-lg-2 d-lg-block sidebar" id="sidebar">
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('hearings.*') ? 'active' : ''); ?>" href="<?php echo e(route('hearings.index')); ?>">
                                <i class="fas fa-calendar-alt"></i>
                                الجلسات
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('hearings.calendar') ? 'active' : ''); ?>" href="<?php echo e(route('hearings.calendar')); ?>">
...
</html><?php /**PATH C:\laragon\www\tibyan-system\resources\views/layouts/app.blade.php ENDPATH**/ ?>