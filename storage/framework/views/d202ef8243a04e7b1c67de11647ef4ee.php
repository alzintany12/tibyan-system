<?php $__env->startSection('title', 'تعديل القضية - نظام تبيان'); ?>

<?php $__env->startSection('content'); ?>
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">
        <i class="fas fa-edit ms-2"></i>
        تعديل القضية: <?php echo e($case->case_number); ?>
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        <div class="btn-group me-2">
            ...
            <a href="<?php echo e(route('cases.show', $case)); ?>" class="btn btn-outline-primary">
...
<form action="<?php echo e(route('cases.update', $case)); ?>" method="POST" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                   id="case_number" name="case_number" value="<?php echo e(old('case_number', $case->case_number)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                   id="case_title" name="case_title" value="<?php echo e(old('case_title', $case->case_title)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                   id="client_name" name="client_name" value="<?php echo e(old('client_name', $case->client_name)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                   id="client_phone" name="client_phone" value="<?php echo e(old('client_phone', $case->client_phone)); ?>">
...
unset($__errorArgs, $__bag); ?>" id="case_type" name="case_type" required>
                                ...
                                <?php $__currentLoopData = \App\Models\CaseModel::getCaseTypes(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($key); ?>" <?php echo e(old('case_type', $case->case_type) == $key ? 'selected' : ''); ?>>
                                        <?php echo e($type); ?>
...
unset($__errorArgs, $__bag); ?>" id="status" name="status" required>
                                <?php $__currentLoopData = \App\Models\CaseModel::getStatuses(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($key); ?>" <?php echo e(old('status', $case->status) == $key ? 'selected' : ''); ?>>
                                        <?php echo e($status); ?>
...
unset($__errorArgs, $__bag); ?>" id="priority" name="priority">
                                <?php $__currentLoopData = \App\Models\CaseModel::getPriorities(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $priority): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($key); ?>" <?php echo e(old('priority', $case->priority) == $key ? 'selected' : ''); ?>>
                                        <?php echo e($priority); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                   id="court_name" name="court_name" value="<?php echo e(old('court_name', $case->court_name)); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select <?php $__errorArgs = ['court_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="court_type" name="court_type">
                                <option value="">اختر نوع المحكمة</option>
                                <?php $__currentLoopData = \App\Models\CaseModel::getCourtTypes(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($key); ?>" <?php echo e(old('court_type', $case->court_type) == $key ? 'selected' : ''); ?>>
                                        <?php echo e($type); ?>

                                    </option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                            <?php $__errorArgs = ['court_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control <?php $__errorArgs = ['opposing_party'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                   id="opposing_party" name="opposing_party" value="<?php echo e(old('opposing_party', $case->opposing_party)); ?>">
                            <?php $__errorArgs = ['opposing_party'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                  id="case_summary" name="case_summary" rows="3"><?php echo e(old('case_summary', $case->case_summary)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                  id="description" name="description" rows="4"><?php echo e(old('description', $case->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                   id="start_date" name="start_date" value="<?php echo e(old('start_date', $case->start_date?->format('Y-m-d'))); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                   id="expected_end_date" name="expected_end_date" value="<?php echo e(old('expected_end_date', $case->expected_end_date?->format('Y-m-d'))); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" class="form-control <?php $__errorArgs = ['next_hearing_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                   id="next_hearing_date" name="next_hearing_date" value="<?php echo e(old('next_hearing_date', $case->next_hearing_date?->format('Y-m-d'))); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="time" class="form-control <?php $__errorArgs = ['next_hearing_time'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                   ...
                                   value="<?php echo e(old('next_hearing_time', $case->next_hearing_time ? $case->next_hearing_time->format('H:i') : '')); ?>">
                            <?php $__errorArgs = ['next_hearing_time'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>" id="fee_type" name="fee_type">
                            <?php $__currentLoopData = \App\Models\CaseModel::getFeeTypes(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($key); ?>" <?php echo e(old('fee_type', $case->fee_type) == $key ? 'selected' : ''); ?>>
                                    <?php echo e($type); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control <?php $__errorArgs = ['total_fees'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                               id="total_fees" name="total_fees" value="<?php echo e(old('total_fees', $case->total_fees)); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control <?php $__errorArgs = ['fees_received'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                               id="fees_received" name="fees_received" value="<?php echo e(old('fees_received', $case->fees_received)); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control <?php $__errorArgs = ['case_value'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                               id="case_value" name="case_value" value="<?php echo e(old('case_value', $case->case_value)); ?>">
                        <?php $__errorArgs = ['case_value'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control <?php $__errorArgs = ['estimated_hours'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                               id="estimated_hours" name="estimated_hours" value="<?php echo e(old('estimated_hours', $case->estimated_hours)); ?>">
                ...
                <div class="card-body">
                    <div class="form-check mb-3">
                        <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1" 
                               <?php echo e(old('is_active', $case->is_active) ? 'checked' : ''); ?>>
                    ...
                    <div class="form-check mb-3">
                        <input class="form-check-input" type="checkbox" id="is_archived" name="is_archived" value="1" 
                               <?php echo e(old('is_archived', $case->is_archived) ? 'checked' : ''); ?>>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\tibyan-system\resources\views/cases/edit.blade.php ENDPATH**/ ?>