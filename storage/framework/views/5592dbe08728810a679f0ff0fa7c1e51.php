<?php $__env->startSection('title', 'تقويم الجلسات - نظام تبيان'); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        events: {
            url: '<?php echo e(route("hearings.calendar.events")); ?>',
            method: 'GET',
            failure: function() {
        ...
        dateClick: function(info) {
            ...
            const addHearingUrl = '<?php echo e(route("hearings.create")); ?>?date=' + info.dateStr;
    ...
    function updateStatistics() {
        fetch('<?php echo e(route("hearings.quick-stats")); ?>')
    ...
    function loadUpcomingHearings() {
        ...
        fetch(`<?php echo e(route("hearings.calendar.events")); ?>?start=${startDate}&end=${endDate}`)
            .then(response => response.json())
            .then(events => {
                if (events.length === 0) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\tibyan-system\resources\views/hearings/calendar.blade.php ENDPATH**/ ?>